...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/metrics/metricsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureMetricsCols';
...
const TableSampleMetrics = ({
  ...
  useEffect(() => {
    if (metricsNotify.showNotification) {
      notify(metricsNotify.typeNotification, metricsNotify.textNotification);
    }
  }, [metricsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/metrics/metrics-view/?id=${id}`);
  };
...
export default TableSampleMetrics;
