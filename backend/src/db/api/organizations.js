...
module.exports = class OrganizationsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.activities_organization =
      await organizations.getActivities_organization({
        transaction,
      });

    output.contacts_organization = await organizations.getContacts_organization(
      {
        transaction,
      },
    );

    output.leads_organization = await organizations.getLeads_organization({
      transaction,
    });

    output.metrics_organization = await organizations.getMetrics_organization({
      transaction,
    });
